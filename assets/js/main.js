			...
			_.$thumbnails.children()
				.each(function() {
					...
					// Slide.
						...
						// Create elements.
	 						s.$slide = $('<div class="slide"><div class="caption"><div class="captionGroup"></div></div><div class="image"></div></div>');
						...
						// Caption.
							s.$slideCaption = s.$slide.find('.captionGroup');
...
$(document).ready(function() {
	...
	console.log("listo");
	/* Fade out todos los logos menos el actual */
	// var elems = $('#thumbnails article');
	// 	elems.on('mouseenter mouseleave', function(e) {
	//   	elems.not(this).stop(true).fadeTo(100, e.type=='mouseenter'?0.3:1);
	// });
